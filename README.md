...
чтобы получился .exe файл и все заработала:
...
2. в строке (7) SAVE_DIR = 'YOUR PATH TO THE DIRECTORY' вписываешь путь до дирректории компа на который будут удаленно сбрасываться файлы через бота (ЕСЛИ УКАЗАТЬ ДИРРЕКТОРИЮ КОТОРОЙ НЕТ НА КОМПЕ ФАЙЛ ВЫДАСТ ОШИБКУ)
